...
class TestGUIDuplicateValidation:
    ...
    def sample_validation_result_with_duplicates(self):
        ...
        return ValidationResult(
            ...
            warnings=["Vehicle BW1 assigned to multiple routes: CX1, CX2 (Drivers: John Smith, Jane Doe)"]
        )
    
    # ==================== Dialog Display Tests ====================
    
    def test_show_duplicate_warning_dialog(self, mock_messagebox, sample_validation_result_with_duplicates):
    ...
    def test_show_duplicate_warning_dialog_user_cancels(self, mock_messagebox, sample_validation_result_with_duplicates):
    ...
    def test_show_duplicate_info_dialog(self, mock_messagebox, sample_validation_result_with_duplicates):
    ...
    def test_allocation_tab_duplicate_validation_integration(self, mock_show_warning, mock_validator_class):
    ...
    def test_validation_progress_updates(self, mock_update_progress):
        ...
        with patch('customtkinter.CTkFrame'), \
             patch('src.gui.allocation_tab.DuplicateVehicleValidator') as mock_validator_class:
    ...
    def test_dialog_theme_consistency(self):
        ...
        with patch('customtkinter.CTkToplevel') as mock_toplevel, \
             patch('customtkinter.set_appearance_mode') as mock_theme:
