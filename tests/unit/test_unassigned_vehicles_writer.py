...
class TestUnassignedVehiclesWriter:
    ...
    def test_create_unassigned_sheet(self, unassigned_writer, sample_unassigned_vehicles_df, vehicle_log_dict):
    ...
    def test_alternating_row_colors(self, writer, sample_unassigned_vehicles, vehicle_log_dict):
        ...
        assert worksheet.cell(row=3, column=1).fill.start_color.rgb is None or \
               worksheet.cell(row=3, column=1).fill.start_color.rgb == "00000000"
    
    def test_export_unassigned_to_csv(self, writer, sample_unassigned_vehicles, vehicle_log_dict, tmp_path):
    ...
    def test_duplicate_sheet_replacement(self, unassigned_writer, sample_unassigned_vehicles_df, vehicle_log_dict):
    ...
    def test_large_dataset_performance(self, unassigned_writer, large_unassigned_vehicles_df):
        ...
        print(f"Large dataset processing: {execution_time:.3f}s for {len(large_unassigned_vehicles_df)} vehicles")
    ...
    def test_data_cell_formatting(self, unassigned_writer, sample_unassigned_vehicles_df, vehicle_log_dict):
        ...
        if unassigned_writer.enable_alternating_rows:
            ...
            assert (odd_row_cell.fill.start_color.rgb is None or 
                   odd_row_cell.fill.start_color.rgb == "00000000")
    ...
    def test_alternating_rows_disabled(self, sample_unassigned_vehicles_df, vehicle_log_dict):
        ...
        for row in range(2, worksheet.max_row + 1):
            ...
            assert (cell.fill.start_color.rgb is None or 
                   cell.fill.start_color.rgb == "00000000")
    
    def test_specific_column_alignment(self, unassigned_writer, sample_unassigned_vehicles_df, vehicle_log_dict):
    ...
    def test_calculate_days_since_assignment_edge_cases(self, unassigned_writer):
        ...
        invalid_date_df = pd.DataFrame([
            {"Van ID": "BW1", "Date": "invalid-date"},
            {"Van ID": "BW1", "Date": None}
        ])
    ...
    def test_csv_export_functionality(self, unassigned_writer, sample_unassigned_vehicles_df, vehicle_log_dict, temp_dir):
        """Test CSV export functionality."""
        ...
        # Check structure
        expected_columns = [
            "Van ID", "Vehicle Type", "Operational Status", 
            "VIN", "GeoTab Code", "Branded or Rental", "Unassigned Date"
        ]
    ...
    def test_csv_export_missing_vehicle_log(self, unassigned_writer, sample_unassigned_vehicles_df, temp_dir):
    ...
    def test_logging_behavior(self, mock_logger, unassigned_writer, sample_unassigned_vehicles_df, vehicle_log_dict):
    ...
    def test_worksheet_name_edge_cases(self, unassigned_writer, sample_unassigned_vehicles_df, vehicle_log_dict):
