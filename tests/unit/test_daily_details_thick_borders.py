...
class TestDailyDetailsThickBorderService:
    ...
    def test_apply_thick_borders_single_date_section(self, thick_border_service, daily_details_with_data):
    ...
    def test_apply_thick_borders_multiple_date_sections(self, thick_border_service, daily_details_with_data):
    ...
    def test_identify_date_sections_continuous_dates(self, thick_border_service, daily_details_workbook):
    ...
    def test_identify_date_sections_scattered_dates(self, thick_border_service, daily_details_workbook):
    ...
    def test_apply_thick_border_to_section_single_row(self, thick_border_service, daily_details_workbook):
    ...
    def test_apply_thick_border_to_section_multiple_rows(self, thick_border_service, daily_details_workbook):
    ...
    def test_apply_thick_borders_after_append_new_date(self, thick_border_service, daily_details_with_data):
    ...
    def test_apply_thick_borders_after_append_same_date(self, thick_border_service, daily_details_workbook):
