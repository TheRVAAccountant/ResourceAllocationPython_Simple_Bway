...
class TestDuplicateVehicleValidator:
    ...
    def test_multiple_complex_duplicates(self, duplicate_validator):
        ...
        allocations = [
            ...
            {"Van ID": "BW1", "Route Code": "CX3", "Associate Name": "Driver C", "Wave": "10:00 AM"},
            
            # BW2 assigned to 2 routes
            {"Van ID": "BW2", "Route Code": "CX4", "Associate Name": "Driver D", "Wave": "8:00 AM"},
            {"Van ID": "BW2", "Route Code": "CX5", "Associate Name": "Driver E", "Wave": "11:00 AM"},
    ...
    def test_performance_large_dataset(self, duplicate_validator, large_allocation_results):
        ...
        assert execution_time < 2.0, f"Validation took {execution_time:.2f} seconds, expected < 2.0s"
        ...
        print(f"Large dataset validation: {execution_time:.3f}s for {len(large_allocation_results)} allocations")
    ...
    def test_logging_behavior(self, mock_logger, duplicate_validator, duplicate_allocation_results):
        ...
        mock_logger.info.assert_any_call(f"Validating {len(duplicate_allocation_results)} allocations for duplicates")
