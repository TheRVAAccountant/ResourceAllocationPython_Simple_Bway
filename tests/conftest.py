...
def sample_unassigned_vehicles_df():
    ...
    return pd.DataFrame(
        [
            {"Van ID": "BW10", "Type": "Large", "Opnal? Y/N": "Y", "Location": "Depot A"},
            {"Van ID": "BW11", "Type": "Extra Large", "Opnal? Y/N": "Y", "Location": "Depot B"},
            {"Van ID": "BW12", "Type": "Step Van", "Opnal? Y/N": "N", "Location": "Depot A"},
            {"Van ID": "BW13", "Type": "Large", "Opnal? Y/N": "Y", "Location": "Depot C"},
            {"Van ID": "BW14", "Type": "Extra Large", "Opnal? Y/N": "N", "Location": "Depot B"},
        ]
    )
...
def test_excel_files(
    temp_dir,
    sample_day_of_ops_df,
    sample_daily_routes_df,
    sample_vehicle_status_df,
    vehicle_log_dict,
):
