...
def mock_services():
    ...
    with patch('src.gui.main_window.AllocationEngine'), \
         patch('src.gui.main_window.ExcelService'), \
         patch('src.gui.main_window.BorderFormattingService'), \
         patch('src.gui.main_window.DashboardDataService'), \
         patch('src.gui.main_window.DataManagementService'), \
         patch('src.gui.main_window.AssociateService'), \
         patch('src.gui.main_window.ScorecardService'):
        yield
