...
def temp_files():
    ...
    day_of_ops_data = pd.DataFrame([
        {"Route Code": "CX1", "Service Type": "Standard Parcel - Large Van", "DSP": "BWAY", "Wave": "8:00 AM", "Staging Location": "STG.G.1"},
        {"Route Code": "CX2", "Service Type": "Standard Parcel - Large Van", "DSP": "BWAY", "Wave": "8:00 AM", "Staging Location": "STG.G.2"},
        {"Route Code": "CX3", "Service Type": "Standard Parcel - Extra Large Van - US", "DSP": "BWAY", "Wave": "9:00 AM", "Staging Location": "STG.G.3"},
        {"Route Code": "CX4", "Service Type": "Standard Parcel - Large Van", "DSP": "OTHER", "Wave": "8:00 AM", "Staging Location": "STG.G.4"},  # Non-BWAY
    ])
