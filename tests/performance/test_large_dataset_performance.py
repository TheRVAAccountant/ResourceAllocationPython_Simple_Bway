...
class TestLargeDatasetPerformance:
    ...
    def performance_monitor(self):
        ...
        class PerformanceMonitor:
            ...
            def report(self, operation_name: str):
                ...
                print(f"  Memory Usage: {self.start_memory:.1f} -> {self.end_memory:.1f} MB (+{self.memory_increase:.1f} MB)")
        
        return PerformanceMonitor()
    
    def generate_large_allocation_dataset(self, count: int, duplicate_rate: float = 0.1) -> List[Dict[str, Any]]:
    ...
    def test_duplicate_validator_1000_allocations(self, duplicate_validator, performance_monitor):
        ...
        assert performance_monitor.execution_time < self.MAX_DUPLICATE_VALIDATION_TIME, \
            f"Validation took {performance_monitor.execution_time:.2f}s, expected < {self.MAX_DUPLICATE_VALIDATION_TIME}s"
        
        assert performance_monitor.memory_increase < self.MAX_MEMORY_INCREASE, \
    ...
    def test_duplicate_validator_5000_allocations(self, duplicate_validator, performance_monitor):
        ...
        assert performance_monitor.execution_time < max_time, \
        ...
        assert performance_monitor.memory_increase < self.MAX_MEMORY_INCREASE * 2, \
    ...
    def test_duplicate_validator_high_duplicate_rate(self, duplicate_validator, performance_monitor):
        ...
        assert performance_monitor.execution_time < self.MAX_DUPLICATE_VALIDATION_TIME * 2, \
    ...
    def test_duplicate_report_generation_performance(self, duplicate_validator, performance_monitor):
        ...
        assert performance_monitor.execution_time < 2.0, \
    ...
    def test_unassigned_writer_1000_vehicles(self, unassigned_writer, performance_monitor):
        ...
        # Performance assertions
        assert performance_monitor.execution_time < self.MAX_UNASSIGNED_PROCESSING_TIME, \
    ...
    def test_unassigned_csv_export_performance(self, unassigned_writer, performance_monitor, temp_dir):
    ...
    def test_unassigned_summary_performance(self, unassigned_writer, performance_monitor):
        ...
        # Should be very fast
        assert performance_monitor.execution_time < 1.0, \
    ...
    def test_thick_borders_1000_rows_single_section(self, thick_border_service, performance_monitor):
        ...
        assert performance_monitor.execution_time < self.MAX_THICK_BORDERS_TIME, \
    ...
    def test_full_allocation_pipeline_performance(self, performance_monitor, temp_dir):
        ...
        assert performance_monitor.execution_time < max_pipeline_time, \
    ...
    def test_scalability_10000_allocations(self, performance_monitor):
        ...
        max_memory = 500  # MB
        assert performance_monitor.memory_increase < max_memory, \
