...
def test_unassigned_vehicles():
    ...
    if not allocator.unassigned_vehicles.empty:
        ...
        print(
            allocator.unassigned_vehicles[
                ["Van ID", "Type", "Staging Location", "Opnal? Y/N"]
            ].head()
        )
    ...
    result, results_file_path = allocator.create_output_file(output_file=daily_summary_path)
