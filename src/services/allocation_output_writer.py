    ...
    def create_results_file(
        ...
        try:
            ...
            self._create_unassigned_sheet(
                workbook, unassigned_vehicles, vehicle_log_dict, alloc_date
            )
    ...
    def _create_unassigned_sheet(
        ...
        if not unassigned_vehicles.empty:
            ...
            for _, vehicle in unassigned_vehicles.iterrows():
                ...
                row_data = [
                    ...
                    vehicle_info.get(
                        "brand_or_rental", vehicle_info.get("Branded or Rental", "")
                    ),  # Handle both cases
        ...
        if row_num > 2:
            sheet.auto_filter.ref = (
                f"A1:{get_column_letter(len(self.UNASSIGNED_COLUMNS))}{row_num-1}"
            )
