...
"""
    ...
    def get_alert_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'latest_alert': self.alert_history[-1].timestamp.isoformat() if self.alert_history else None
        }
    ...
    async def start_monitoring(self) -> None:
        ...
        try:
            while self.monitoring_active:
                ...
                self.record_metric('system_memory_percent', psutil.virtual_memory().percent, 'percent')
