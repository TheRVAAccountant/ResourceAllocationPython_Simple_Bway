...
from src.models.excel import (
    ExcelRange, ExcelStyle, ExcelWorksheet,
    BorderStyle, ExcelColor, ExcelFont, ExcelBorder,
    ExcelAlignment, ExcelFill, ExcelFormula, ExcelValidation
)
    ...
    def _apply_style_xlwings(self, sheet: Any, excel_range: ExcelRange, style: ExcelStyle) -> None:
        ...
        if style.font:
            ...
            if style.font.color and style.font.color.rgb:
                range_obj.font.color = tuple(int(style.font.color.rgb[i:i+2], 16) 
                                            for i in (0, 2, 4))
