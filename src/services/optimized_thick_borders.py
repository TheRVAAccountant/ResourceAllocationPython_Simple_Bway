...
class OptimizedThickBorderService:
    ...
    def _calculate_border_operations(
        ...
        for section_date, (first_row, last_row) in date_sections.items():
            ...
            section_ops = self._calculate_section_borders(
                first_row, last_row, section_date
            )
    ...
    def _process_sections_chunk(
        self,
        worksheet: Worksheet,
        sections: Dict[date, Tuple[int, int]]
    ):
