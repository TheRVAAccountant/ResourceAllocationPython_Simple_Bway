...
from src.utils.recent_files_manager import FileFieldType, RecentFilesManager, RecentFileInfo
...
class RecentFilesPopup(ctk.CTkToplevel):
    ...
    def _create_file_item(self, file_info: RecentFileInfo):
        ...
        if file_info.exists:
            ...
            item_frame.bind("<Enter>", lambda e: item_frame.configure(
                fg_color=("gray85", "gray25")
            ))
            item_frame.bind("<Leave>", lambda e: item_frame.configure(
