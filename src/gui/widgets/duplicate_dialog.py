...
class DuplicateValidationDialog:
    ...
    def _setup_content(self):
        ...
        # Summary
        summary_text = f"Found {self.validation_result.duplicate_count} vehicles assigned to multiple routes"
    ...
    def _populate_details(self):
        ...
        for vehicle_id, duplicate in self.validation_result.duplicates.items():
            ...
            for i, assignment in enumerate(duplicate.assignments, 1):
                ...
                details_text += f"     Timestamp: {assignment.assignment_timestamp.strftime('%H:%M:%S')}\n\n"
