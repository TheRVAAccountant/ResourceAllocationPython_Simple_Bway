...
class AllocationTab:
    ...
    def create_configuration_section(self):
        ...
        self.date_entry = ctk.CTkEntry(
            left_config_frame,
            textvariable=self.allocation_date
        )
        ...
        self.optimize_checkbox = ctk.CTkCheckBox(
            right_config_frame,
            text="Optimize allocation before processing"
        )
        ...
        self.validate_checkbox = ctk.CTkCheckBox(
            right_config_frame,
            text="Validate results after allocation"
        )
        ...
        self.borders_checkbox = ctk.CTkCheckBox(
            right_config_frame,
            text="Apply daily section borders"
        )
        ...
        self.open_after_checkbox = ctk.CTkCheckBox(
            right_config_frame,
            text="Open Daily Summary Log after completion"
        )
    ...
    def _apply_default_daily_summary(self):
        ...
        if use_default and default_path:
            ...
            if p.exists():
                ...
                logger.warning("Configured default Daily Summary Log path does not exist; ignoring.")
    ...
    def _run_allocation_thread(self):
        ...
        try:
            ...
            allocator.load_vehicle_status(self.daily_summary_path.get(), sheet_name="Vehicle Status")
            ...
            self.update_results("Adding/updating: Daily Details, Results, and Unassigned sheets...\n")
            ...
            try:
                ...
                self.update_results("⚠️ Unable to record allocation history entry. Check logs for details.\n")
    ...
    def display_gas_allocation_results(self, allocator):
        ...
        duplicate_count = len([r for r in allocator.allocation_results if r.get('Validation Status') == 'DUPLICATE'])
        ...
        if hasattr(allocator, 'unassigned_vehicles') and allocator.unassigned_vehicles is not None and not allocator.unassigned_vehicles.empty:
    ...
    def _open_daily_summary_log_async(self, file_path: str):
        ...
        try:
            ...
            logger.debug(f"Could not schedule Daily Summary Log open via after: {exc}; opening immediately.")
            _open_file()
